...
5) hodlr_level = This decides the switching level $\ell$ (where the admissibility conditions will be switched) in the hybrid admissibility condition. For example, if hodlr_level = 1, then switching level $\ell = L-1$.
